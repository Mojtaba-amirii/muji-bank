...
export default function Register() {
  ...
  return (
    <section className=" h-fit bg-linear-to-b from-purple-700 to-purple-900 flex items-center justify-center p-4 sm:p-6 lg:p-10 rounded-md">
          ...
          <div className="rounded-md shadow-xs -space-y-px">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-purple-300 placeholder-purple-500 text-gray-900 focus:outline-hidden focus:ring-purple-500 focus:border-purple-500 focus:z-10 sm:text-sm"
